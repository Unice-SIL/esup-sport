...
use App\Datatables\Button\UtilisateurBloquerButton;
use App\Datatables\Button\UtilisateurDebloquerButton;
...
class UtilisateurDatatable extends AbstractTranslatedDatatable
{
    ...
    {
        return 'App\Entity\Uca\Utilisateur';
    }
    ...
    public function getStatutUtilisateur($id = 'id', $libelle = 'libelle')
    {
        ...
        $statuts = $em->getRepository(StatutUtilisateur::class)->findAll();
