...
class TraductionQuery
{
    ...
    public function init($em, $langAll, $LangDefault)
    {
        $this->em = $em;
    ...
    public function qbInit()
    {
        ...
        $qb->from('App\Entity\Uca\Annotation', 'annotation');
    ...
    {
        $this->joins['App\Entity\Uca\Annotation'] = [
            'alias' => 'cke',
            'table' => 'App\Entity\Uca\Annotation',
            'join' => "cke.entity = annotation.entity AND cke.field = annotation.field AND cke.annotation = 'App\\Annotations\\CKEditor'",
        ];
