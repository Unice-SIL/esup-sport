...
class UtilisateurRepository extends ServiceEntityRepository
{
    ...
    public function getNbreUserInscriptActivite($listeUsername, $statut)
    {
        $qb = $this->createQueryBuilder('u')
            ...
            ->andWhere('u.username IN (:listeUsername)')
            ->setParameter('listeUsername', $listeUsername)
            ->innerJoin('App\Entity\Uca\Inscription', 'i', 'WITH', 'i.utilisateur = u')
    ...
    public function findOneByIdentifiant(string $identifiant): ?Utilisateur {
        return $this->createQueryBuilder('u')
            ->andWhere('u.email = :identifiant or u.username = :identifiant')
