...
{
    /**
     * @Route("/", name="ProfilUtilisateurLister")
    ...
    /**
     * @Route("/Ajouter", name="ProfilUtilisateurAjouter")
    ...
    public function ajouterAction(Request $request)
    {
        ...
        if ($request->isMethod('POST') && $form->handleRequest($request)->isValid()) {
            ...
            return $this->redirectToRoute('ProfilUtilisateurLister');
        }
        $twigConfig['item'] = $item;
        $twigConfig['form'] = $form->createView();
        return $this->render('@Uca/UcaGest/Securite/ProfilUtilisateur/Formulaire.html.twig', $twigConfig);
    }

    /**
     * @Route("/Supprimer/{id}", name="ProfilUtilisateurSupprimer")
     * @Isgranted("ROLE_GESTION_PROFIL_UTILISATEUR_ECRITURE")
     */
    ...
    /**
     * @Route("/Modifier/{id}", name="ProfilUtilisateurModifier")
     * @Isgranted("ROLE_GESTION_PROFIL_UTILISATEUR_ECRITURE")
     */
