...
class TypeActiviteController extends Controller
{
    ...
    /**
     * @Route("/Ajouter", name="TypeActiviteAjouter")
    ...
    public function ajouterAction(Request $request)
    {
        ...
        if ($request->isMethod('POST') && $form->handleRequest($request)->isValid()) {
            ...
            return $this->redirectToRoute('TypeActiviteLister');
        }
    ...
    /**
     * @Route("/Modifier/{id}", name="TypeActiviteModifier")
     * @Isgranted("ROLE_GESTION_TYPE_ACTIVITE_ECRITURE")
     */
    ...
    /**
     * @Route("/Supprimer/{id}", name="TypeActiviteSupprimer")
     * @Isgranted("ROLE_GESTION_TYPE_ACTIVITE_ECRITURE")
     */
