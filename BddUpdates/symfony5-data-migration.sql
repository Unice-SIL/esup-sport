...
UPDATE `ext_log_entries` SET `object_class`=replace(`object_class`, 'UcaBundle\\Entity\\', 'App\\Entity\\Uca\\');
UPDATE `ext_translations` SET `object_class`=replace(`object_class`, 'UcaBundle\\Entity\\', 'App\\Entity\\Uca\\');
