...
class ReservabiliteTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->reservabilite->addProfilsUtilisateur(
            (new ReservabiliteProfilUtilisateur($this->reservabilite, $this->profilUtilisateur, 14))
                ->setNbInscrits(10)
        );
    }
    ...
    {
        $this->assertEquals(14, $this->reservabilite->getCapaciteProfil($this->profilUtilisateur));
    }
}
