...
class InscriptionTest extends KernelTestCase
{
    ...
    public function testSeDesinscrire(): void
    {
        ...
        $manager->persist($this->comportementAutorisation);
        $manager->persist($this->typeAutorisation);
        $manager->persist($this->comportementAutorisationFormat);
        $manager->persist($this->typeAutorisationFormat);
        $manager->persist($this->format);
        $manager->persist($this->formatActivite);
        $manager->persist($this->inscription);
        $manager->persist($this->utilisateur);

        $manager->persist($comportementAutorisation);
        $manager->persist($typeAutorisationFormat);
        $manager->persist($format);
        $manager->persist($tmp_inscription);
        $manager->flush();
        ...
        $manager->remove($this->comportementAutorisation);
        $manager->remove($this->typeAutorisation);
        $manager->remove($this->comportementAutorisationFormat);
        $manager->remove($this->typeAutorisationFormat);
        $manager->remove($this->format);
        $manager->remove($this->formatActivite);
        $manager->remove($this->inscription);
        $manager->remove($this->utilisateur);

        $manager->remove($comportementAutorisation);
        $manager->remove($typeAutorisationFormat);
        $manager->remove($format);
        $manager->remove($tmp_inscription);
        $manager->flush();
    }
    ...
    {
        // dd($this->inscription->addCommandeDetail());
