 ...
 * @coversNothing
 */
class ActiviteConrotllerTest extends WebTestCase
{
    private $client;
    ...
    protected function tearDown(): void
    {
        ...
        $this->em->remove($this->em->getRepository(FormatActivite::class)->find($this->ids['formatAvecReservation']));
        $this->em->remove($this->em->getRepository(Ressource::class)->find($this->ids['ressourceLieu']));
        $this->em->remove($this->em->getRepository(FormatActivite::class)->find($this->ids['formatAchatCarte']));
        $this->em->remove($this->em->getRepository(Creneau::class)->find($this->ids['creneau']));
        $this->em->remove($this->em->getRepository(FormatActivite::class)->find($this->ids['formatAvecCreneau']));
        $this->em->remove($this->em->getRepository(FormatActivite::class)->find($this->ids['formatSimple']));
