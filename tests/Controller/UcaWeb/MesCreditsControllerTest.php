...
class MesCreditsControllerTest extends WebTestCase
{
    ...
    protected function tearDown(): void
    {
        ...
        $this->em->remove($this->em->getRepository(Utilisateur::class)->findOneByEmail('user_credit@test.fr'));
        $this->em->remove($this->em->getRepository(Utilisateur::class)->findOneByEmail('user_no_credit@test.fr'));
    ...
    public function accessDataProvider()
    {
        return [
            ...
            ['user_credit@test.fr','GET','UcaWeb_MesCreditsExport',Response::HTTP_OK,['id'=>'id_credit']],
    ...
    public function testAccesRoutes($userEmail, $method, $routeName, $httpResponse, $urlParameters = [], $body = [], $ajax = false): void
    {
        ...
        $route = str_replace('id_credit', $this->creditId, $route);
