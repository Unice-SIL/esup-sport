...
class InscriptionVoterTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $user = (new Utilisateur())
            ->setEmail('InscriptionVoterTest@test.fr')
            ->setUsername('InscriptionVoterTest')
    ...
    public function testVoteOnAttribute(): void
    {
        ...
        $user = static::getContainer()->get(UtilisateurRepository::class)->findOneByUsername('InscriptionVoterTest');
    ...
    public function testVoteOnAttributeAuthorized(): void
    {
        ...
        $inscription = (new Inscription(
            ...
            new Utilisateur(),
            ['typeInscription' => 'format']
        ))->setListeEmailPartenaires('InscriptionVoterTest@test.fr');
